    ...
    <>
      {currentId === id 
        ?
          <>
            <div className="work">
              <h1 className="activeWork h2" id={id} onClick={(e) =>setCurrent(id)}>{work.title.toUpperCase()}</h1>
        ...
        :
          <>
            <div className="work">
              <h1 className="h2" id={id} onClick={(e) =>setCurrent(id)}>{work.title.toUpperCase()}</h1>
